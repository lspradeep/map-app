package com.android.w2sapp.utils;
...
import com.android.w2sapp.data.models.map.Step;
 ...
 *
 * https://github.com/akexorcist/GoogleDirectionLibrary/blob/master/google-direction/src/main/java/com/akexorcist/googledirection/util/DirectionConverter.java
 */
...
public class DirectionConverter {
    ...
    private static void convertStepToPosition(Step step, ArrayList<LatLng> directionPointList) {
        // Get start location
        directionPointList.add(new LatLng(step.getStartLocation().getLat(), step.getStartLocation().getLng()));
        ...
        // Get end location
        directionPointList.add(new LatLng(step.getEndLocation().getLat(), step.getEndLocation().getLng()));
    }
    ...
    public static ArrayList<LatLng> getSectionPoint(List<Step> stepList) {
        ...
        if (stepList != null && stepList.size() > 0) {
            ...
            directionPointList.add(new LatLng(stepList.get(0).getStartLocation().getLat(),stepList.get(0).getStartLocation().getLng()));
            for (Step step : stepList) {
                // Get end location
                directionPointList.add(new LatLng(step.getEndLocation().getLat(),step.getEndLocation().getLng()));
            }
